...
type StreamType = "ReadableStream" | "BinaryStream" | "FileStream" | "JSONStream"
  | "ChunkStream" | "Uint8ArrayStream" | "BufferStream" | "MultipartStream";
...
const BUN_STREAM_MIGRATION_MATRIX: readonly StreamMigrationEntry[] = [
  {
    ...
    rScore: 1.0,
    complexityBefore: 4, complexityAfter: 1, edgeCases: 0,
    latencyNs: 45, latencyToleranceNs: 5, memoryDeltaBytes: -128,
    securityTier: "HARD", streamType: "ReadableStream",
  ...
  },
  {
    ...
    rScore: 1.0,
    complexityBefore: 4, complexityAfter: 1, edgeCases: 0,
    latencyNs: 50, latencyToleranceNs: 5, memoryDeltaBytes: -192,
    securityTier: "HARD", streamType: "BinaryStream",
  ...
  },
  {
    ...
    rScore: 1.0,
    complexityBefore: 4, complexityAfter: 1, edgeCases: 0,
    latencyNs: 55, latencyToleranceNs: 5, memoryDeltaBytes: -256,
    securityTier: "HARD", streamType: "FileStream",
  ...
  },
  {
    ...
    rScore: 1.0,
    complexityBefore: 5, complexityAfter: 1, edgeCases: 0,
    latencyNs: 65, latencyToleranceNs: 5, memoryDeltaBytes: -160,
    securityTier: "HARD", streamType: "JSONStream",
  ...
  },
  {
    ...
    rScore: 1.0,
    complexityBefore: 4, complexityAfter: 1, edgeCases: 0,
    latencyNs: 70, latencyToleranceNs: 5, memoryDeltaBytes: -128,
    securityTier: "HARD", streamType: "ChunkStream",
  ...
  },
  {
    ...
    converter: "readableStreamToText",
    rScore: 0.995,
    complexityBefore: 5, complexityAfter: 1, edgeCases: 1,
    latencyNs: 48, latencyToleranceNs: 5, memoryDeltaBytes: -144,
    securityTier: "HARD", streamType: "Uint8ArrayStream",
  ...
  },
  {
    ...
    rScore: 1.0,
    complexityBefore: 4, complexityAfter: 1, edgeCases: 0,
    latencyNs: 60, latencyToleranceNs: 5, memoryDeltaBytes: -160,
    securityTier: "HARD", streamType: "BufferStream",
  ...
  },
  {
    ...
    rScore: 1.0,
    complexityBefore: 7, complexityAfter: 1, edgeCases: 0,
    latencyNs: 90, latencyToleranceNs: 10, memoryDeltaBytes: -320,
    securityTier: "HARD", streamType: "MultipartStream",
