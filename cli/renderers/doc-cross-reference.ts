...
export const API_PROVENANCE: Readonly<Record<string, string>> = {
  ...
  "Bun.dns.lookup": "<1.2", "Bun.dns.prefetch": "<1.2", "Bun.dns.getCacheStats": "<1.2",
  "$ (shell)": "<1.2", "$.braces": "<1.2", "$.escape": "<1.2",
  "Bun.spawn": "<1.2", "Bun.spawnSync": "<1.2",
  "Bun.file": "<1.2", "Bun.write": "<1.2",
  "Bun.stdin": "<1.2", "Bun.stdout": "<1.2", "Bun.stderr": "<1.2",
  "Bun.build": "<1.2", "Bun.Transpiler": "<1.2",
  "Bun.FileSystemRouter": "<1.2", "Bun.plugin": "<1.2",
  "Bun.password": "<1.2", "Bun.hash": "<1.2", "Bun.CryptoHasher": "<1.2",
  "bun:sqlite": "<1.2",
  "Bun.gzipSync": "<1.2", "Bun.gunzipSync": "<1.2",
  "Bun.deflateSync": "<1.2", "Bun.inflateSync": "<1.2",
  "Bun.version": "<1.2", "Bun.revision": "<1.2", "Bun.env": "<1.2", "Bun.main": "<1.2",
  "Bun.sleep": "<1.2", "Bun.nanoseconds": "<1.2",
  "Bun.which": "<1.2", "Bun.peek": "<1.2", "Bun.deepEquals": "<1.2",
  "Bun.inspect": "<1.2", "Bun.inspect.table": "<1.2",
  "Bun.escapeHTML": "<1.2", "Bun.stringWidth": "<1.2",
  "Bun.resolveSync": "<1.2", "Bun.resolve": "<1.2",
  "Bun.fileURLToPath": "<1.2", "Bun.pathToFileURL": "<1.2",
  "Bun.Glob": "<1.2",
  "HTMLRewriter": "<1.2",
  "Bun.readableStreamToText": "<1.2", "Bun.readableStreamToJSON": "<1.2",
  "Bun.readableStreamToArray": "<1.2", "Bun.readableStreamToArrayBuffer": "<1.2",
  "Bun.readableStreamToBytes": "<1.2", "Bun.readableStreamToBlob": "<1.2",
  "Bun.readableStreamToFormData": "<1.2",
  "bun:ffi": "<1.2", "bun:test": "<1.2", "Worker": "<1.2",
  "Bun.gc": "<1.2", "Bun.generateHeapSnapshot": "<1.2",
  "bun:jsc": "<1.2", "Node-API": "<1.2", "import.meta": "<1.2",
  "Bun.semver": "<1.2",
  // 1.2.0
  "Bun.sql": "1.2.0", "Bun.postgres": "1.2.0", "Bun.SQL": "1.2.0",
  "Bun.S3Client": "1.2.0", "Bun.s3": "1.2.0",
  "Bun.color": "1.2.0",
  // 1.3.0
  "Bun.redis": "1.3.0", "Bun.RedisClient": "1.3.0",
  // 1.3.4
  "URLPattern": "1.3.4", "URLPattern.test": "1.3.4",
  "URLPattern.exec": "1.3.4", "URLPattern.hasRegExpGroups": "1.3.4",
  "FormData.from": "1.3.4",
  "Bun.FFI.CString": "1.3.4", "Bun.FFI.linkSymbols": "1.3.4",
  // 1.3.5
  "Bun.Terminal": "1.3.5", "bun:bundle": "1.3.5",
  // 1.3.6
...
export class DocumentationScanner {
  ...
  report(file: string, code: string): DocCoverageReport {
    ...
    return {
      ...
      documented,
      undocumented,
      coveragePercent: apisUsed.length > 0
        ? Math.round((documented.length / apisUsed.length) * 100)
        : 100,
    };
  }
}
